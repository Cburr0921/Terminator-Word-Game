...
| Title              | Image                                                                 |
|---------------------|----------------------------------------------------------------------|
| **Game Load Page**  | ![Game Screenshot](/assets/TerminatorWordGameScreenshot.png)         |
| **Game Start**      | ![Game Screenshot](/assets/TerminatorWordGameScreenshot2.png)        |
| **Wireframe**       | ![Wireframe](/assets/Wireframe.png)                                  |
